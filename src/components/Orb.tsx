...
export default function Orb({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      // Update hue animation
      currentHue = (currentHue + dt * 15 * hueRotationSpeed) % 360;
  ...
  }, [initialHue, hueRotationSpeed, hoverIntensity, rotateOnHover, forceHoverState]);
